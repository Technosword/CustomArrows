...
/*
Mostly not my code, but a great util I like to use. No need to reinvent the wheel
 */
...
public class ItemFactory {
    ...
    /**My own method which adds custom model data
     * @return The existing ItemFactory instance
     */
    public ItemFactory addCustomModelData(int num) {
